  ...
  return (
    <div className="d-flex flex-column vh-100">
      ...
      <header>
        <Navbar
          expand="lg"
          className="d-flex flex-column align-items-stretch p-2 pb-0 mb-3 fixed-top bg-body-tertiary"
          bg="dark"
        >
          <Container>
            ...
            <Navbar.Collapse id="basic-navbar-nav">
              <Nav className="me-auto">
                <Nav.Link
                  href="#"
                  className="nav-link header-link justify-content-end"
                ...
                <Nav.Link href="/cart" className="nav-link header-link p-0">
                  {
